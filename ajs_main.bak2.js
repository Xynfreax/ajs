...
css_propiedades__={
  ...
  css_propiedades=[//-Otro
    {
      props:[
        ...
        ,'transition','opacity'
        ,'tableLayout','textTransform','listStyleType'
  ...
  dom_propiedades=[
    ...
    ,'colSpan','autofocus','required','selectedIndex','min','max','step','maxLength','multiple'],
      setter_general:function(k,v){
        //--console.log(this);
        this.json_l[k]=v;
        //--this['_'+k]=v;
    ...
    */
    ...
    preinit:{configurable:true,writable:true,enumerable:false,value:function(asf,resi){
      ...
      if(resi!=='resize'){
        ...
        var actObj=this_;
        var arObj=[];
        while(actObj!==undefined && actObj.json_l!==undefined && actObj['load_r']!==undefined){
